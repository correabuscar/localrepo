...
src_configure() {
	...
	cat <<- _EOF_ > "${S}"/config.toml
		...
		#patch made!'none' here means .tar only! or don't set any value here!//nvm patch not made! //keep 'gz' here so that 0600_fabricate_neutering_try2_just_tar_not_gz_or_xz_for_rust_1_52_0.patch applies neatly
