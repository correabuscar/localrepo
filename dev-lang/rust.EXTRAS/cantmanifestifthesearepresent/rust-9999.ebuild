...
src_configure() {
	...
	rust_target="$(rust_abi)"
		...
		#llvm: optimize = $(toml_usex !debug)
		#rustc: optimize-tests = $(toml_usex !debug)
...
#rustc = "/usr/bin/rustc"
#fail: Trying to avoid stage0 cargo/rustc saying -Z is only allowed on nightly! -Z is used in RUSTFLAGS= of /etc/portage/make.conf !
#because: I guess I can't use this! due to error: attributes starting with rustc are reserved for use by the rustc compiler
#--> library/core/src/num/int_macros.rs:2050:15
